...
module.bundle.HMR_BUNDLE_ID = "e91039d2f50b2295";
...
},{}],"4wmf3":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "BlessingList", ()=>BlessingList
);
class BlessingList extends HTMLElement {
    connectedCallback() {
        ...
        if (items.length) items.forEach((text)=>{
